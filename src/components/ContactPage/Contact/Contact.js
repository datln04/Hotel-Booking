            ...
            <div className="col-12 d-flex justify-content-between">
              <div className="col-5">
                ...
                <div className="hs-text-dark-grey">
                  ...
                  Nhằm mục đích nâng cao trãi nghiệm và cải thiện dịch vụ một
                  cách tốt nhất.
                </div>
              </div>
              <div className="col-5">
              ...
              <div className="col-5">
                <div className="hs-py-8 col-12 d-block">
                  <div className="hs-py-16 d-flex hs-text-white text-lg">
                    ...
                    <p className="hs-text-dark-grey">{hotelInfo.address}</p>
                  </div>
                  <div className="hs-py-16 d-flex hs-text-white text-lg">
                    <i className="fa-solid fa-phone hs-pr-16"></i>
                    <p className="hs-text-dark-grey">{hotelInfo.phoneNumber}</p>
                  </div>
                  <div className="hs-py-16 d-flex hs-text-white text-lg">
                    <i className="fa-regular fa-envelope hs-pr-16"></i>
                    <p className="hs-text-dark-grey">{hotelInfo.email}</p>
                  </div>
