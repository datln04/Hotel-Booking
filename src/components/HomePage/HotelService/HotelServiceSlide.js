  ...
  return (
    <div className={classNames("hs-text-white", Styles.slideContainer)}>
      <div className={classNames("", Styles.image)}>
        <img src={service.images[0].pictureUrl} alt="img" />
      </div>
      <div
        className={classNames("hs-py-24 hs-px-24 hs-text-dark-brown text-lg")}
      >
        <TextTruncate text={service.name} mobile="5" desktop="4" />
      </div>
      <div
        className={classNames("hs-pb-16 hs-px-24 hs-text-black-grey text-md")}
      >
