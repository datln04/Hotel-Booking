...
const NewsComponent = () => {
  ...
  const couponData = [
    {
      ...
      title: "Party Combo 3",
      hightLight:
        "Combo 3 dành cho 4 đến 6 người ăn nay với mức giá ưu đãi chỉ còn 999.000 VND",
      description:
        "+ Chả giò Hoàng Kim (size M) \n + Súp cua hoa trùng thào (size M) \n + Sườn heo nướng mật ong rừng (size M) \n + Cơm chiên cá mặn gà xé (size M) \n + Tôm sốt trứng muối (size M)",
    },
    {
      imageUrl: imageCoupon2,
      title: "Combo Chất Ngất",
      hightLight:
        "Combo chất ngất với đa dạng món ăn và nước uống sẽ giúp quý khách có một bữa ăn đầy đủ...",
      description:
        "+ Chả giò Hoàng Kim (size M) \n + Súp cua hoa trùng thào (size M) \n + Sườn heo nướng mật ong rừng (size M) \n + Cơm chiên cá mặn gà xé (size M) \n + Tôm sốt trứng muối (size M)",
    },
  ];
  ...
  const destinationData = [
    {
      ...
      title: "Chợ Bến Thành",
      description:
        "Theo Vương Hồng Sển, tác giả của cuốn sách ‘Sài Gòn năm xưa’ năm 1912, người Pháp đã lấp hồ Boresse, có diện tích khoảng 12.000m2 và xây dựng một khu chợ trên đó. Chợ nằm sát bến cảng (Bến) của Sài Gòn xưa (Thành), do đó được đặt tên là Bến Thành. ",
      dateTime: "08:00 - 19:00",
      location:
        "Chợ Bến Thành nằm ở ngã tư Lê Lợi, Hàm Nghi, Trần Hưng Đạo và Lê Lai.",
    },
    {
    ...
    },
    {
      ...
      title: "Tháp Bitexco",
      description:
        "Tháp Bitexco Financial Sky & Sky Deck tại Thành phố Hồ Chí Minh cao 262 mét tại trung tâm thành phố và cung cấp cho du khách một cái nhìn thành phố tuyệt vời từ Sky Deck. Được thiết kế bởi kiến trúc sư nổi tiếng người Mỹ Carlos Zapata",
  ...
  const eventData = [
    ...
    },
    {
      ...
      location: "Hồ Chí Minh",
      title:
        "THE COFFEE EXPO VIETNAM 2022 - Triển lãm Quốc tế Cà Phê, Bánh và Trà tại Việt Nam",
          ...
          return (
            <div className="hs-pb-32 row" key={idx}>
              ...
              <div className="col-7">
                ...
                <div className="hs-text-dark-grey">Vị trí: {des.location}</div>
              </div>
            </div>
          );
        })}
      ...
      <div className="col-6 hs-px-32 hs-py-24">
        ...
        >
          ...
          <div className="hs-px-16 hs-py-8">
            <div className="hs-text-dark-grey">{ev.location}</div>
            <div className="">
            ...
            <div className={classNames("col-12 hs-py-8", Styles.subContentTab)}>
              ...
              <div className="hs-text-dark-grey">
                ...
                {ev.startDate}
                {startDateTime !== endDateTIme ? " - " + ev.endDate : ""}
              </div>
            </div>
          </div>
        </div>
